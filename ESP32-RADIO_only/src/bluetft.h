...
#define YELLOW     ST7735_RED
#define MAGENTA   ST7735_GREEN
#define BLUE    MAGENTA | CYAN
#define GREEN YELLOW | CYAN
#define RED  YELLOW | MAGENTA
#define BLACK   YELLOW | CYAN | MAGENTA
...
{                                                           // One text line is 8 pixels
  ...
  { false, CYAN,   20, 48, "" },                            // 8 lines in the middle
  { false, YELLOW, 72, 48, "" },                            // 4 lines at the bottom
  { false, GREEN,  72, 32, "" }                             // 4 lines at the bottom for rotary encoder
} ;
...
// The indicator is 2 pixels heigh. ~AC changed from 2 to 4                                                       *
//**************************************************************************************************
void displayvolume()
{
  if ( tft )
