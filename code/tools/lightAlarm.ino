//********************************************************************************************
// Initialize the preferences op ESP32-lightAlarm.  They can be edited later by the webinterface. *
//********************************************************************************************
// 27-04-2017, ES: First set-up, derived from preferences example sketch.                    *
// 11-02-2019, ES: names of I/O pins changed.                                                *
// 14-08-2019, AC: modified for ESP32-lightAlarm  //**AC**
//********************************************************************************************

#include <Preferences.h>

// Note: Namespace name is limited to 15 chars.  Same name must be used in ESP32-lightAlarm. //**AC**
#define NAME "lightAlarm" //**AC**
...
void setup()
{
  ...
  // Store the preferences for ESP32-lightAlarm  //**AC**
...
void loop()
{
  Serial.println ( "ESP32_lightAlarm_init completed..." ) ; //**AC**
  delay ( 10000 ) ;
}
