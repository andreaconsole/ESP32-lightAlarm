...
{                                                           // One text line is 8 pixels
  { false, BLACK,   4,  30, "" },                            // 1 top line
  { false, CYAN,    64, 24, "" },                            // 8 lines in the middle
  { false, YELLOW,  100, 24, "" },                            // 4 lines at the bottom
  { false, GREEN,  100, 24, "" }                             // 4 lines at the bottom for rotary encoder
} ;
